...
namespace ISNogometniStadion.WebAPI.Migrations
{
    ...
    [Migration("20191204124133_novePreporuke")]
    partial class novePreporuke
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISNogometniStadion.WebAPI.Database.PreporukePoLokaciji", b =>
                {
                    b.Property<int>("PreporukaID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PreporukePoLokaciji");
                });

            modelBuilder.Entity("ISNogometniStadion.WebAPI.Database.PreporukePoStadionu", b =>
                {
                    b.Property<int>("PreporukaID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PreporukePoStadionu");
                });

            modelBuilder.Entity("ISNogometniStadion.WebAPI.Database.PreporukePoTimu", b =>
                {
                    b.Property<int>("PreporukaID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ISNogometniStadion.WebAPI.Database.Uplate", b =>
                {
            ...
            modelBuilder.Entity("ISNogometniStadion.WebAPI.Database.PreporukePoTimu", b =>
                {
                    ...
                    b.HasOne("ISNogometniStadion.WebAPI.Database.Timovi", "Tim")
                        .WithMany()
                        .HasForeignKey("TimID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ISNogometniStadion.WebAPI.Database.Uplate", b =>
                {
                    b.HasOne("ISNogometniStadion.WebAPI.Database.Ulaznice", "Ulaznica")
                        .WithOne("Uplata")
                        .HasForeignKey("ISNogometniStadion.WebAPI.Database.Uplate", "UlaznicaID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
